import Grapes from './config/grapes.js';
import config from './config/index.js';
import ExchangeClientModule from './exchangeClientModule.js';
...
const grapeUrl = config.protocol + grapeHostname + ':' + Grapes?.[Math.floor(Math.random() * Grapes.length)].api_port

const client = new ExchangeClientModule({grapeUrl, port, announceInterval: config.announceInterval})
client.start((err) => {
    if (err) {
